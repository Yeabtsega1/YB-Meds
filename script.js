...
// const API_KEY = 'AIzaSyDILHTGDkxNSQhmu4F6UwADLwRlqvTgPKY'; // Replace 'YOUR_GEMINI_API_KEY' with your actual API key
...
// // Example usage:
// const userMessage = "Can you help me with procurement strategies?";
...
const API_KEY = 'AIzaSyDILHTGDkxNSQhmu4F6UwADLwRlqvTgPKY';

const trainingPrompt = [
    {
        "role": "user",
        "parts": [{"text": "This is Introductory dialogue for any prompt :  'Hello, my dear friend, Ask me anything regarding procurement, purchase, and logistics. I will be happy to help you. '"}]
    },
    // Additional prompt training data...
];
...
function getChatGPTResponse() {
    ...
    sendMessage(userInput)
        .then(response => {
            document.getElementById("recommendation-result").innerHTML = `Recommended Medication: ${response}`;
            hideLoadingAnimation();
        })
        .catch(error => {
            console.error('Error getting GPT response:', error);
            document.getElementById("recommendation-result").innerHTML = 'An error occurred while getting the recommendation.';
            hideLoadingAnimation();
        });
}
